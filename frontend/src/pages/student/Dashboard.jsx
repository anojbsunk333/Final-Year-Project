...
export default function StudentDashboard() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response.success && response.user.role === "student") {
        ...
        setError(
          response.message || "Only student users can access this dashboard",
        );
      }
    } catch (err) {
        ...
        {user && user.role === "student" ? (
          <div className="rounded-2xl bg-white p-8 shadow-lg border-2 border-primary-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-8">
              ...
              <div className="rounded-xl bg-gradient-to-br from-orange-50 to-orange-100 p-6 border border-orange-200">
                ...
                <p className="text-3xl font-bold text-orange-900 mt-2">Paid</p>
              </div>
            </div>
          </div>
        ) : showLoginForm ? (
          ...
          <div className="rounded-2xl bg-white p-8 shadow-lg border-2 border-primary-200 text-center">
            ...
            <p className="text-gray-600 mt-2">
              Welcome to the student portal. Please log in to continue.
            </p>
            <button
